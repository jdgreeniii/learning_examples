...
BLUE_SHIP = pygame.image.load(os.path.join('game', 'assets', 'pixel_ship_blue_small.png'))
GREEN_SHIP = pygame.image.load(os.path.join('game', 'assets', 'pixel_ship_green_small.png'))
RED_SHIP = pygame.image.load(os.path.join('game', 'assets', 'pixel_ship_red_small.png'))
YELLOW_SHIP = pygame.image.load(os.path.join('game', 'assets', 'pixel_ship_yellow.png'))
